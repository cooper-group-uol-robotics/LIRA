...
public class ArucoClient_2 {
    ...
    public ArucoClient_2(IApplicationData appData, RoboticsAPIContext context) {
        this.appData = appData;
        this.context = context;
    }

    public void updateMarkerFrame(String stationName, int id) {
        try {
