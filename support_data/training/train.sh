...
TRAIN_DATA_PATH=./dataset/train_data.json  # path to the training data json file
EVAL_DATA_PATH=./dataset/eval_data.json    # path to the evaluation data json file (optional)
IMAGE_FOLDER=./dataset/resized_images                      # path to the image root folder; if provided, the image paths in the json should be relative
